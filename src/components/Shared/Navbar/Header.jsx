...
const Header = () => {
  ...
  useEffect(() => {
    if ( state.clicked === true || (state.clicked === true && state.initial === null)) {
       gsap.to([link1, link2], { duration: 0.1,  display: 'none', ease: "power3.inOut", delay: 0, stagger:{amount: 0.1}})}
       else if (state.clicked === false) {
        gsap.to([link1, link2], { duration: 0.4,  display: 'block', ease: "power3.inOut", delay: 0.5,stagger:{amount: 0.1}})
       }
  });
