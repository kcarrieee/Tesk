    ...
    <header className={styles.header}>
      ...
      <div className={styles.header__rightcol}>
       ...
       <div onClick={onLogout}>
        ...
        <path d="M21.5 12.5H18.5M20 12.5V15.5M24.125 17L25.25 15.875M20 19.25V21.5H17.75" stroke="black" strokeLinecap="round" strokeLinejoin="round"/>
        <rect x="0.5" y="0.5" width="39" height="39" rx="19.5" stroke="#EAECEE"/>
        </svg>
        </div>
        <Link to='/profile'>
        <div className={styles.pic}>
          {  image ?
                <img src={image} alt="profile-pic" style={{width:'100px', borderRadius: 100,objectFit: 'cover'}}/>
              : auth.currentUser.photoURL ?
                <img src={auth.currentUser.photoURL}  alt="photoURL" style={{width:'100px', borderRadius: 100, objectFit: 'cover'}}/>
              : <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
