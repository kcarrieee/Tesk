    ...
    useEffect(()=> {
      ...
      const onSubmitImage = async () => {
        try {
          ...
          console.log('onSubmit image is ok')
        } catch (error) {
          console.warn(error)
        }}
  ...
  return (
    ...
    <div className='flex gap-4 md:gap-14'>
      <div className='profile_details'>
        ...
        {thumbnail ?  
        <img src={window.URL.createObjectURL(thumbnail)} errerPolicy='no-referrer'  alt="profile-pic" style={{width:'100px', borderRadius: 100, marginTop:15}}/> 
        : auth.currentUser.photoURL ?
        <img src={auth.currentUser.photoURL} errerPolicy='no-referrer' alt="profile photoURL" style={{width:'100px', borderRadius: 100, marginTop:15}}/>
        :
        image ?
